...
def main():
    ...
    # Initialize UART
    ser = serial.Serial('/dev/ttyUSB1', 115200, timeout=0.01)
    ...
    while True:  # Main game loop
        ...
        msg = 'Click tile, press arrow keys, or use SNES controller to slide.'
            ...
            if event.type == MOUSEBUTTONUP:
                ...
                if (spotx, spoty) == (None, None):
                    ...
                    if RESET_RECT.collidepoint(event.pos):
                        resetAnimation(mainBoard, allMoves)  # Reset button
                        allMoves = []
                    elif NEW_RECT.collidepoint(event.pos):
                        mainBoard, solutionSeq = generateNewPuzzle(80)  # New Game button
                        allMoves = []
                    elif SOLVE_RECT.collidepoint(event.pos):
                        resetAnimation(mainBoard, solutionSeq + allMoves)  # Solve button
                        allMoves = []
                else:
